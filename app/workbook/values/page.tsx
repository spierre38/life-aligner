...
<head>
  <meta charset="UTF-8" />
  <title>My Values — Tim Collins Framework</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .section-label { font-family: 'Helvetica Neue', Arial, sans-serif; font-size: 10px; font-weight: 700; letter-spacing: 0.14em; text-transform: uppercase; color: #888; margin-bottom: 20px; }
    .value-item { display: flex; gap: 20px; padding: 16px 0; border-bottom: 1px solid #eee; align-items: flex-start; }
    .value-num { font-family: 'Helvetica Neue', Arial, sans-serif; font-size: 11px; font-weight: 700; color: #bbb; min-width: 24px; padding-top: 3px; }
    .value-name { font-size: 16px; font-weight: 600; margin-bottom: 4px; letter-spacing: -0.01em; }
    .value-desc { font-size: 13px; color: #555; line-height: 1.6; }
...
<body>
  ...
  <div class="section-label">Values — Prioritized (${prioritizedValues.length})</div>
  ${prioritizedValues.map((v, i) => `
