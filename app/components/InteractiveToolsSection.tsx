...
export function InteractiveToolsSection() {
    ...
    return (
        <section id="tools" className="min-h-screen flex items-center py-20 bg-white relative overflow-hidden">
            ...
            <div className="absolute bottom-20 left-20 w-64 h-64 bg-gradient-to-br from-teal-100 to-blue-100 rounded-full opacity-30 blur-3xl"></div>
            ...
            <div className="max-w-6xl mx-auto px-4 w-full relative z-10">
                ...
                <div className="flex justify-center gap-4 mb-12">
                    <button
                        ...
                        className={`flex items-center gap-3 px-8 py-4 rounded-full font-semibold text-lg transition-all ${activeTab === 'lifeframe'
                    ...
                    <button
                        ...
                        className={`flex items-center gap-3 px-8 py-4 rounded-full font-semibold text-lg transition-all ${activeTab === 'roadmap'
