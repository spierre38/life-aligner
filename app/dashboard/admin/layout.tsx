    ...
    return (
        <div className="min-h-screen bg-gray-950 text-white flex">
            ...
            >
                ...
                <div className="p-4 border-t border-gray-800 flex-shrink-0 bg-gray-900/95 backdrop-blur-sm">
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-2 rounded-xl text-red-400 hover:text-red-300 hover:bg-red-500/10 transition-all text-sm cursor-pointer"
                    >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
